...
/*
FrozenBalance represents the frozen balance RPC on the MXP network.

RPC:
	../<block_id>/context/delegates/<pkh>/frozen_balance (GET)

Link:
	https://MXP.gitlab.io/api/rpc.html#get-block-id-context-delegates-pkh-frozen-balance
*/
...
/*
Delegate represents the frozen delegate RPC on the MXP network.

RPC:
	../<block_id>/context/delegates/<pkh> (GET)

Link:
	https://MXP.gitlab.io/api/rpc.html#get-block-id-context-delegates-pkh
*/
...
/*
BakingRights represents the baking rights RPC on the MXP network.

RPC:
	../<block_id>/helpers/baking_rights (GET)

Link:
	https://MXP.gitlab.io/api/rpc.html#get-block-id-helpers-baking-rights
*/
...
/*
EndorsingRights represents the endorsing rights RPC on the MXP network.
...
/*
BakingRightsInput is the input for the goMXP.BakingRights function.

Function:
	func (t *GoMXP) BakingRights(input *BakingRightsInput) (*BakingRights, error) {}
*/
...
/*
EndorsingRightsInput is the input for the goMXP.EndorsingRights function.

Function:
	func (t *GoMXP) EndorsingRights(input *EndorsingRightsInput) (*EndorsingRights, error) {}
*/
...
/*
DelegatesInput is the input for the goMXP.Delegates function.

Function:
	func (t *GoMXP) Delegates(blockhash string) ([]string, error) {}
*/
...
Link:
	https://MXP.gitlab.io/api/rpc.html#get-block-id-context-delegates-pkh-delegated-contracts
...
*/
func (t *GoMXP) DelegatedContracts(blockhash, delegate string) ([]*string, error) {
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoMXP) DelegatedContractsAtCycle(cycle int, delegate string) ([]*string, error) {
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoMXP) FrozenBalance(cycle int, delegate string) (FrozenBalance, error) {
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoMXP) Delegate(blockhash, delegate string) (Delegate, error) {
...
Link:
	https://MXP.gitlab.io/api/rpc.html#get-block-id-context-delegates-pkh-staking-balance
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoMXP) StakingBalance(blockhash, delegate string) (*big.Int, error) {
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoMXP) StakingBalanceAtCycle(cycle int, delegate string) (*big.Int, error) {
	snapshot, err := t.Cycle(cycle)
	if err != nil {
...
Link:
	https://MXP.gitlab.io/api/rpc.html#get-block-id-helpers-endorsing-rights
...
Link:
	https://MXP.gitlab.io/api/rpc.html#get-block-id-context-delegates
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoMXP) Delegates(input DelegatesInput) ([]*string, error) {
	err := validator.New().Struct(input)
	if err != nil {
